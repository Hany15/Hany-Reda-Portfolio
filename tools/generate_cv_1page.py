...
RU = {
 ...
 "contact": CONTACT_RU,
 "l_profile": "Профиль",
 "profile": "Full-Stack разработчик (инженер-программист) с опытом более 3 лет: веб-, мобильные и AI-продукты от требований до релиза. Веду продукты по полному циклу — требования, архитектура, разработка, тестирование, релиз — "
